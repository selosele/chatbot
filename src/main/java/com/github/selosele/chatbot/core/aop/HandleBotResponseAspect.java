...
/**
 * 봇 응답을 처리하는 AOP
 * 카카오톡, 슬랙, 라인, 텔레그램 등 모든 봇의 응답을 처리
 */
@Slf4j
@Aspect
@Component
public class HandleBotResponseAspect {
     ...
     */
    @AfterReturning(pointcut = "@annotation(com.github.selosele.chatbot.core.annotation.BotHandler)", returning = "response")
